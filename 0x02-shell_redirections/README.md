...
Write a script that prints “Hello, World”, followed by a new line to the standard output.
    ...
    camilo@home-laptop:/tmp/h$ ./0-hello_world 
    Hello, World
    camilo@home-laptop:/tmp/h$ ./0-hello_world | cat -e
    Hello, World$
...
*   Directory: [`0x02-shell_redirections`](/0x02-shell_redirections)
...
Write a script that displays a confused smiley `"(Ôo)'`.
    ...
    camilo@home-laptop:/tmp/h$ ./1-confused_smiley 
    "(Ôo)'
    camilo@home-laptop:/tmp/h$ 
...
Example:
    ...
    camilo@home-laptop:/tmp/h$ cat iacta 
    Alea iacta est
    ...
    camilo@home-laptop:/tmp/h$ ./6-third_line 
    Alea iacta est ("The die is cast") is a Latin phrase attributed by Suetonius
    camilo@home-laptop:/tmp/h$     
...
Write a shell script that creates a file named exactly `\*\\'"Best School"\'\\*$\?\*\*\*\*\*:)` containing the text `Best School` ending by a new line.
    ...
    camilo@home-laptop:~/shell$ ls && ./7-file && ls -l && cat -e \\*
...
Write a script that writes into the file `ls_cwd_content` the result of the command `ls -la`. If the file `ls_cwd_content` already exists, it should be overwritten. If the file `ls_cwd_content` does not exist, create it.
    ...
    camilo@home-laptop:/tmp/h$ ls -la
    total 20
    ...
    camilo@home-laptop:/tmp/h$ ./8-cwd_state 
    camilo@home-laptop:/tmp/h$ ls -la
    total 24
    drwxrwxr-x  2 julien julien 4096 Sep 20 18:18 .
    drwxrwxrwt 13 root   root   4096 Sep 20 18:18 ..
    ...
    camilo@home-laptop:/tmp/h$ cat ls_cwd_content 
    total 20
    drwxrwxr-x  2 julien julien 4096 Sep 20 18:18 .
    drwxrwxrwt 13 root   root   4096 Sep 20 18:18 ..
    -rwxrw-r--  1 julien julien   36 Sep 20 18:18 8-cwd_state
...
Example:
    ...
    Read more: https://en.wikipedia.org/wiki/Alea_iacta_est
    camilo@home-laptop:/tmp/h$ ./9-duplicate_last_line 
    camilo@home-laptop:/tmp/h$ cat iacta 
    Alea iacta est
...
Write a script that deletes all the regular files (not the directories) with a `.js` extension that are present in the current directory and all its subfolders.
    ...
    camilo@home-laptop:/tmp/h$ ls -lR
    .:
    total 24
    ...
    ./dir.js:
    total 0
    camilo@home-laptop:/tmp/h$ ./10-no_more_js 
    camilo@home-laptop:/tmp/h$ ls -lR
    .:
    total 24
    -rwxrw-r-- 1 julien julien   49 Sep 20 18:29 10-no_more_js
...
Example:
    ...
    camilo@home-laptop:/tmp/0x02$ cat list 
    C#
    C
    Javascript
    Perl
    ...
    Javascript
    ASP
    camilo@home-laptop:/tmp/0x02$ cat list | ./13-unique 
    C
    C++
    Go
    camilo@home-laptop:/tmp/0x02$ 
...
Replace all characters `A` and `c` from input to `Z` and `e` respectively.
    ...
    camilo@home-laptop:/tmp/0x02$ echo 'Replace all characters `A` and `c` from input to `Z` and `e`.' | ./19-AZ 
...
Create a script that removes all letters `c` and `C` from input.
    ...
    camilo@home-laptop:/tmp/0x02$ echo Chicago | ./20-hiago 
    hiago
    camilo@home-laptop:/tmp/0x02$ 
...
Write a script that reverse its input.
    ...
    camilo@home-laptop:/tmp/0x02$ echo "Reverse" | ./21-reverse 
    esreveR
    camilo@home-laptop:/tmp/0x02$ 
...
Example:
    ...
    camilo@home-laptop:/tmp/0x02$ cat /etc/passwd
    ...
    camilo@home-laptop:/tmp/0x02$
    camilo@home-laptop:/tmp/0x02$ ./22-users_and_homes 
    _apt:/nonexistent
...
Example:
    ...
    camilo@home-laptop:/tmp/0x02$ cat An\ Acrostic 
    ...
    camilo@home-laptop:/tmp/0x02$ ./102-acrostic < An\ Acrostic 
    ELIZABETH
    camilo@home-laptop:/tmp/0x02$ 
...
Here is an example with one day of logs of the NASA website (1995).
    ...
    camilo@home-laptop:/tmp/0x02$ wget https://s3.amazonaws.com/alx-intranet.hbtn.io/public/nasa_19950801.tsv
    ...
    camilo@home-laptop:/tmp/0x02$ head nasa_19950801.tsv
    ...
    camilo@home-laptop:/tmp/0x02$ ./103-the_biggest_fan < nasa_19950801.tsv 
